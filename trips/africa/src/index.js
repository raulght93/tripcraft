...
export const AFRICA_TRIP = {
  ...
  // Catálogo de fauna/flora (slice icónico; migración parcial de species.js, 81 total).
  // kind ∈ mammal|primate|bird|marine|reptile|plant|gorilla. Imágenes Wikipedia 500px.
  species: [
    { id: "lion", name: "León africano", scientific: "Panthera leo", kind: "mammal", img: "https://upload.wikimedia.org/wikipedia/commons/thumb/a/a6/020_The_lion_king_Snyggve_in_the_Serengeti_National_Park_Photo_by_Giles_Laurent.jpg/500px-020_The_lion_king_Snyggve_in_the_Serengeti_National_Park_Photo_by_Giles_Laurent.jpg", desc: "Big 5. Manadas en sabanas abiertas, mejor visto al amanecer. Los machos de Mara tienen melena oscura distintiva.", phases: ["safari-ke", "safari-tz-norte", "safari-tz-sur", "botswana", "namibia"], activities: ["safari"] },
    { id: "elephant", name: "Elefante africano", scientific: "Loxodonta africana", kind: "mammal", img: "https://upload.wikimedia.org/wikipedia/commons/thumb/9/94/178_Male_African_bush_elephant_in_Etosha_National_Park_Photo_by_Giles_Laurent.jpg/500px-178_Male_African_bush_elephant_in_Etosha_National_Park_Photo_by_Giles_Laurent.jpg", desc: "Big 5. Chobe (Botsuana) y Tarangire tienen las mayores concentraciones. Damaraland alberga la población adaptada al desierto.", phases: ["safari-ke", "safari-tz-norte", "safari-tz-sur", "botswana", "namibia", "victoria"], activities: ["safari", "boat"] },
    { id: "leopard", name: "Leopardo africano", scientific: "Panthera pardus pardus", kind: "mammal", img: "https://upload.wikimedia.org/wikipedia/commons/thumb/7/70/African_leopard_male_%28cropped%29.jpg/500px-African_leopard_male_%28cropped%29.jpg", desc: "Big 5. Solitario y elusivo, casi siempre sobre árboles. Serengeti tiene las densidades más altas.", phases: ["safari-ke", "safari-tz-norte", "safari-tz-sur", "botswana"], activities: ["safari"] },
    { id: "cheetah", name: "Guepardo", scientific: "Acinonyx jubatus", kind: "mammal", img: "https://upload.wikimedia.org/wikipedia/commons/thumb/9/92/Male_cheetah_facing_left_in_South_Africa.jpg/500px-Male_cheetah_facing_left_in_South_Africa.jpg", desc: "Animal terrestre más rápido (110 km/h). Activos al mediodía. Maasai Mara y Serengeti son los mejores santuarios.", phases: ["safari-ke", "safari-tz-norte", "namibia"], activities: ["safari"] },
    { id: "wildebeest", name: "Ñu común", scientific: "Connochaetes taurinus", kind: "mammal", img: "https://upload.wikimedia.org/wikipedia/commons/thumb/f/fb/Blue_Wildebeest%2C_Ngorongoro.jpg/500px-Blue_Wildebeest%2C_Ngorongoro.jpg", desc: "Protagonista de la gran migración: 1.5 millones cruzan el Mara cada año (jul-oct) y paren en Ndutu (ene-feb).", phases: ["safari-ke", "safari-tz-norte"], activities: ["safari"] },
    { id: "zebra", name: "Cebra de llanura", scientific: "Equus quagga", kind: "mammal", img: "https://upload.wikimedia.org/wikipedia/commons/thumb/4/45/Equus_quagga_burchellii_-_Etosha%2C_2014.jpg/500px-Equus_quagga_burchellii_-_Etosha%2C_2014.jpg", desc: "Migración con ñus en el Serengeti-Mara. Cada cebra tiene un patrón de rayas único, como una huella dactilar.", phases: ["safari-ke", "safari-tz-norte", "safari-tz-sur", "botswana", "namibia"], activities: ["safari"] },
    { id: "hippo", name: "Hipopótamo", scientific: "Hippopotamus amphibius", kind: "mammal", img: "https://upload.wikimedia.org/wikipedia/commons/thumb/f/f2/Portrait_Hippopotamus_in_the_water.jpg/500px-Portrait_Hippopotamus_in_the_water.jpg", desc: "Más muertes humanas que cualquier otro mamífero africano. Mejor verlos en boat safari.", phases: ["safari-ke", "safari-tz-sur", "victoria", "botswana", "malawi"], activities: ["safari", "boat"] },
    { id: "whale-shark", name: "Tiburón ballena", scientific: "Rhincodon typus", kind: "marine", img: "https://upload.wikimedia.org/wikipedia/commons/thumb/f/f6/Similan_Dive_Center_-_great_whale_shark.jpg/500px-Similan_Dive_Center_-_great_whale_shark.jpg", desc: "El pez más grande del mundo (12 m). Mafia (oct-feb) tiene avistamientos casi garantizados, también Sodwana y Dahab.", phases: ["mafia", "sodwana", "egypt"], activities: ["snorkel", "diving"] },
    { id: "colobus", name: "Colobo blanco y negro", scientific: "Colobus guereza", kind: "primate", img: "https://upload.wikimedia.org/wikipedia/commons/thumb/b/b2/Mantled_Guereza.jpg/500px-Mantled_Guereza.jpg", desc: "Bosques de la costa swahili y montañas etíopes. Salto espectacular entre árboles, melena blanca como capa.", phases: ["watamu", "ethiopia"], activities: ["trekking"] },
    { id: "baobab", name: "Baobab de Grandidier", scientific: "Adansonia grandidieri", kind: "plant", img: "https://upload.wikimedia.org/wikipedia/commons/thumb/a/a8/Adansonia_grandidieri04.jpg/500px-Adansonia_grandidieri04.jpg", desc: "Endémico del oeste malgache. La Avenue des Baobabs cerca de Morondava es la imagen icónica.", phases: ["madagascar"], activities: ["trekking"] },
  ],
